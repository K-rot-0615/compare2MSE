...
for a in range(len(images1)):
    ws.write(5 * a, 0, "hoge1")
    ws.write(5 * a + 1, 0, "hoge2")
    ws.write(5 * a + 2, 0, "mse")
    ws.write(5 * a + 3, 0, "ssim")
    ws.write(5 * a, 1, "img" + str(a))
    for b in range(len(images2)):
        ...
        mean_square_error, structural_similarity = compare_images(
            img1_gray, img2_gray)
        # print(mean_square_error)

        ws.write(5 * a + 1, b + 1,  "img" + str(b))
        ws.write(5 * a + 2, b + 1, str(mean_square_error))
        ws.write(5 * a + 2, b + 1, str(mean_square_error))
